                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-2">
                                <button class="btn btn-primary poppins" data-toggle="modal" data-target="#myModal"
                                    ng-click="add_form()" style="width: 100%;"><i class="ti-plus"></i> Tambah Data</button>
                            </div>
                        </div>
                        <div class="data-tab">
                            <table datatable="ng" class="table table-bordered table-jabatan">
                                ...
                                <tbody style="font-size: 12px">
                                    <tr class="text-center" ng-repeat="row in polakegiatan">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-item">
                            <input type="text" class="forms-label" id="pola">
                            <label for="jenis">Pola Kegiatan</label>
...
@section('javascript')
    ...
    <script src="{{ asset('assets/js/admin/pola_kegiatan/app.js') }}"></script>
    <script src="{{ asset('assets/js/admin/pola_kegiatan/service.js') }}"></script>
@endsection
