<x-layout :datalayout="$data" :datalogin="$datalogin">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="data-tab">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="alert alert-info poppins">PIlih terlebih dahulu kelompok pendapatan
                                            untuk
                                    ...
                                    <div class="col-12">
                                        <table datatable="ng" class="table table-bordered table-jabatan">
                                            <thead class="bg-light" style="font-size: 12px;">
                                                <tr class="text-center">
                                                    <th>Kode</th>
                                                    <th>Kelompok Pendapatan Desa</th>
                                                    <th>
                                                        Aksi
                                                    </th>
                                                </tr>
                                    ...
                                    <div class="col-6">
                                        <div class="alert alert-info poppins">Data Jenis Pendapatan Desa Berdasarkan
                                            Kelompok
                                        ...
                                        <table datatable="ng" class="table table-bordered table-jabatan">
                                            ...
                                            <tbody style="font-size: 12px">
                                                <tr class="text-center" ng-repeat="row in jenisdata">
                                                    ...
                                                    <td>@{{ row.keterangan }}</td>
                                                    <td>
                                                        <button class="btn btn-primary" ng-click="pilih_jenis(row,1)"
                                                            ng-if="row.status==0">Pilih</button>
                                                        <button class="btn btn-danger" ng-click="pilih_jenis(row,0)"
                                                            ng-if="row.status==1">Batal</button>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <table class="table table-bordered" style="margin-top: 25px;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Keterangan Objek Pendapatan</td>
                                                    <td>
    ...
    @section('javascript')
        ...
        <script src="{{ asset('assets/js/admin/pendapatan/objek/app.js') }}"></script>
        <script src="{{ asset('assets/js/admin/pendapatan/objek/service.js') }}"></script>
    @endsection
</x-layout>
