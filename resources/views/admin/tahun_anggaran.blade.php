                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-2">
                                <button class="btn btn-primary poppins" data-toggle="modal" data-target="#myModal"
                                    ng-click="clear_input()" style="width: 100%;"><i class="ti-plus"></i> Tambah Data</button>
                            </div>
                        </div>
                        <div class="data-tab">
                            <table datatable="ng" class="table table-bordered table-jabatan">
                                ...
                                <tbody style="font-size: 12px">
                                    <tr class="text-center" ng-repeat="row in anggarantahun">
                                        <td>@{{ row.tahun }}</td>
                                        <td>@{{ row.ket }}</td>
                                        <td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-item">
                            <input type="text" class="anggaran-tahun forms-label">
                            <label>Tahun Anggaran</label>
                            <p class="poppins"><small style="color: red"> * </small> Wajib Di Isi</p>
                        </div>
                        <div class="form-item">
                            <select class="forms-label anggaran-tahun">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" ng-hide="aksi" ng-click="save()"><i class="ti-save"></i> SIMPAN</button>
                        <button type="button" class="btn btn-success" ng-show="aksi" ng-click="update()"><i class="ti-save"></i> PERBARUI</button>
...
@section('javascript')
    ...
    <script src="{{ asset('assets/js/admin/tahun anggaran/app.js') }}"></script>
    <script src="{{ asset('assets/js/admin/tahun anggaran/service.js') }}"></script>
@endsection
