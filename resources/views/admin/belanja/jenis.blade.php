                                ...
                                <div class="col-6">
                                    ...
                                    <table class="table table-bordered" style="margin-top: 25px;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Keterangan Kelompok Belanja</td>
                                                <td>
...
@section('javascript')
    ...
    <script src="{{ asset('assets/js/admin/belanja/jenis/app.js') }}"></script>
    <script src="{{ asset('assets/js/admin/belanja/jenis/service.js') }}"></script>
@endsection
