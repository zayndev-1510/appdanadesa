                ...
                <div class="card">
                    <div class="card-body">
                        <div class="data-tab">
                            <div class="row">
                                <div class="col-12">
                                    <div class="alert alert-info poppins">PIlih terlebih dahulu kelompok belanja untuk menampilkan data jenis belanja desa</div>
                                </div>
                                <div class="col-12">
                                    <table datatable="ng" class="table table-bordered table-jabatan">
                                        <thead class="bg-light" style="font-size: 12px;">
                                ...
                                <div class="col-6">
                                    <div class="alert alert-info poppins">Data Jenis Belanja Desa Berdasarkan Kelompok Belanja Desa Yang Dipilih</div>
                                    <table datatable="ng" class="table table-bordered table-jabatan">
                                        <thead class="bg-light" style="font-size: 12px;">
                                            <tr class="text-center">
                                                <th>Kode</th>
